...
def verify_candidate(expected_commit, core_directory, adapter_directory):
    ...
    if core_version != declared_version:
        raise ValueError(
            ...
            f"soklet-servlet-jakarta baseline {declared_version}; do not override soklet.version"
        )
...
def main():
    ...
    print(f"Declared soklet-servlet-jakarta baseline: com.soklet:soklet:{declared_version}")
